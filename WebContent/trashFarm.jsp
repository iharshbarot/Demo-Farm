...
function res(id)
{
	if(confirm("You Want to Restore this Account"))
		{
		   window.location.href= "insertData?a=10&id="+id;
		}
}
function del(id)
{
	if(confirm("You Want to Delete this Account"))
		{
		   window.location.href= "insertData?a=11&id="+id;
		}
}
</script>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                     &nbsp;  &raquo;  &nbsp; <a href="#">Trash Farm list</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-header well">
             <h2><i class="	glyphicon glyphicon-trash"></i> Trash Farm List</h2>
                 <div class="box-icon">
                </div>
            </div>
...
<c:forEach items="${requestScope.list}" var="v" varStatus="count">
                    ...
                    <td>
               		     <input type="button" value="Restore" class="btn btn-info" onclick="res(${v.u_id})" />
