...
<c:forEach items="${requestScope.list}" var="v" varStatus="count">
  ...
  <div class="text-center">
    ...
    Buyer Name:${v.sell_owner_name},
    Selling Price: ${v.sellingPrice} Rs,
    Selling time avrage of Milk: ${v.sell_avg_milk} Ltr/Year,
    Selling Date:${v.sellDate},
